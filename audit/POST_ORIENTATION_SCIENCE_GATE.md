...
Generated 2026-08-03T00:59:51+00:00 at `43ace26b3f3e` by `scripts/emit_jhep_science_gate.py`.
...
| 1.3 | Candidate accounting and the rank-81 certificate | **PASS** | 164/164 |
| 1.4 | Degree-resolved tensor-spinor span equivalence | **PASS** | 55/55 |
| 1.5 | Degree-ten application | **PASS** | 10/10 |
| 1.5b | Exact rational D10 | **PASS** | 9/9 |
| 1.5c | Exact rational Q10 | **PASS** | 8/8 |
...
> Sample x prime matrix: 3/3 seeds [11, 22, 33], 3/3 fitting primes [32717, 32719, 32749], 2/2 holdout primes [32707, 32713], 15/15 cells. Complete.
...
## 1.5b Exact rational D10

**Status: PASS**

*Requirement.* dim_Q D10 established over the rationals, not at good primes: an independent verifier using a different algorithm, a lower-bound minor with two agreeing determinant routines, and an upper bound by exact annihilating covectors.
...
> The raw span of all 37 degree-10 targets is 14 and would give a quotient of 0. It is a different object; see docs/FLOW_ACTIVATION_SEMANTICS.md.

## 1.5c Exact rational Q10

**Status: PASS**

*Requirement.* Q10 constructed rather than inferred from 14 - 11: representatives shown outside D10, independent modulo it, spanning, and each needed.
