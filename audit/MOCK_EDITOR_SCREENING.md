...
supplement. The one claim a reader might most want to check by hand is now
checkable by hand: the intersection of the published span with the products is
generated by an explicit integer identity among four published structures, and it
is printed. A reader who never opens the repository can follow every claim; they
