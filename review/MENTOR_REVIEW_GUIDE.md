...
- **Where:** §5.3, p. 8 [`sec:orientation`]; appendix B, p. 30 [`app:orientation`].
...
- **Where:** §5 [`sec:bridge`], which begins on p. 5 and runs to p. 6; appendix A, p. 29 [`app:conventions`].
...
- **Where:** §9.1, p. 16 [`sec:reach`]; appendix H, p. 36 [`app:closure`].
...
- **Where:** §10, p. 19 [`sec:gten`]; appendix I, p. 37 [`app:gten`].
...
- **Where:** §8, p. 13 [`sec:rank`]; appendix G, p. 35 [`app:rank81`].
...
- **Where:** title page; §1, p. 1 [`sec:intro`]; §14, p. 25 [`sec:limitations`].
