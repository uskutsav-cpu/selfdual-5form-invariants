...
the elementary cardinality bound of proposition 6 [`prop:cardinality`].
...
- **Where:** §5.3, p. 8 [`sec:orientation`]; appendix B, p. 29 [`app:orientation`].
...
- **Where:** §5 [`sec:bridge`], which begins on p. 5 and runs to p. 6; appendix A, p. 27 [`app:conventions`].
...
- **Where:** §9.1, p. 15 [`sec:reach`]; appendix H, p. 34 [`app:closure`].
...
- **Where:** §10, p. 18 [`sec:gten`]; appendix I, p. 35 [`app:gten`].
...
- **Where:** §8, p. 12 [`sec:rank`]; appendix G, p. 33 [`app:rank81`].
...
- **Where:** title page; §1, p. 1 [`sec:intro`]; §14, p. 24 [`sec:limitations`].
