...
Conventions here follow the standard supergravity and string-theory
sources~\cite{VanProeyen:1999ni,Freedman:2012zz,Polchinski:1998rr,GreenSchwarzWitten:1987};
the underlying spin-geometric facts, in particular the
structure of the chiral modules and the symmetry properties of
$C\Gamma^{(k)}$, are set out in~\cite{Lawson:1989}. We record the choices
explicitly rather than by reference because several results below are sensitive
to them.
